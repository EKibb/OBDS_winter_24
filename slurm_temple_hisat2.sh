...
samtools sort -@ 12 /project/oues0566/1_linux/rnaseq/4_outputs/2_mapping/ERR1755086.bam > /project/oues0566/1_linux/rnaseq/4_outputs/2_mapping/ERR1755086_sorted.bam
